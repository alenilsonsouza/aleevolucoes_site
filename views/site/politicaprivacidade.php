...
<section class="areaTitulo">
	<div class="conteudo conteudoAreaTitulo">
		<h1>Política de Privacidade <img src="<?php echo BASE_URL;?>assets/images/seta.svg" class="pisca"></h1>
	</div>
</section>
<section class="conteudo conteudoInterno areaPrivacidade marginBottom">
	<h2>Política de privacidade para <a href='https://www.aleevolucoes.com.br'>Ale Evoluções</a></h2>
	...
	<p>A garantia da confidencialidade dos dados pessoais dos utilizadores do nosso site é importante para o Ale Evoluções.</p>

	<p>Todas as informações pessoais relativas a membros, assinantes, clientes ou visitantes que usem o Ale Evoluções serão tratadas em concordância com a Lei da Proteção de Dados Pessoais de 26 de outubro de 1998 (Lei n.º 67/98).</p>
	...
	<p>O uso do Ale Evoluções pressupõe a aceitação deste Acordo de privacidade. A equipe do Ale Evoluções reserva-se ao direito de alterar este acordo sem aviso prévio. Deste modo, recomendamos que consulte a nossa política de privacidade com regularidade de forma a estar sempre atualizado.</p>
	...
	<p>O Ale Evoluções possui ligações para outros sites, os quais, a nosso ver, podem conter informações / ferramentas úteis para os nossos visitantes. A nossa política de privacidade não é aplicada a sites de terceiros, pelo que, caso visite outro site a partir do nosso deverá ler a politica de privacidade do mesmo.</p>
